...
- Make it **descriptive** (per Git Workflow in `frontend-standards.md`).
...
- `docs/frontend-standards.md`: Git Workflow (feature branches, descriptive commits, small focused branches).
